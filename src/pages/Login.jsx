...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    console.log("Iniciando sesión como:", formData.rol);
    navigate('/dashboard');
  };
  ...
  const inputClasses = "w-full pl-10 pr-4 py-3 rounded-xl text-gray-900 bg-white/95 backdrop-blur-sm border border-white/20 focus:border-yellow-400 focus:ring-4 focus:ring-yellow-400/20 outline-none transition-all duration-300 font-medium placeholder:text-gray-500/80 shadow-sm text-sm";
  const labelClasses = "text-white/90 text-[10px] font-bold uppercase tracking-widest ml-1 mb-1 block";
        ...
        <div className="min-h-full flex flex-col justify-center p-6 sm:p-8">
            ...
            <div className="flex flex-col items-center mb-6">
                <div className="bg-white p-3 rounded-2xl shadow-lg mb-4 transform hover:scale-105 transition-transform">
                    <img src="/LOGO NELSON 2026-2031.JPG" alt="Logo Unidos" className="w-24 h-auto object-contain"/>
                </div>
            ...
            <div className="mt-8">
                <div className="relative flex items-center py-3">
                    ...
                    <span className="flex-shrink mx-2 text-red-100/70 text-[10px] font-bold uppercase tracking-widest">Acceso Público</span>
                    <div className="flex-grow border-t border-red-300/30"></div>
                </div>
                <button 
