...
const Sidebar = () => {
    ...
    return (
        <aside className="w-72 bg-white border-r border-gray-200 flex flex-col h-full z-30 font-sans">
            ...
            <div className="h-16 flex items-center px-6 border-b border-gray-200 bg-[#00008B]">
            ...
            <nav className="flex-1 py-6 px-3 space-y-1 overflow-y-auto">
                ...
                {menuPermitido.map((item) => {
                    ...
                    return (
                        ...
                        ${isActive
                                    ? 'bg-blue-50 text-[#00008B] border-l-4 border-[#00008B]'
            ...
            <div className="p-4 border-t border-gray-200">
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 hover:text-[#00008B] hover:border-blue-200 transition-all text-sm font-semibold"
                >
                    <LogOut size={16} />
                    Cerrar Sesión
                </button>
